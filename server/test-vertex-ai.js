...
async function testVertexAI() {
  console.log('🧪 Testing Vertex AI Function Calling Implementation\n');
  ...
  console.log(`   Project ID: ${googleApiService.projectId}`);
  console.log(`   Location: ${googleApiService.location}`);
  console.log(`   Model: ${googleApiService.model}`);
  console.log(`   Mock Mode: ${googleApiService.mockMode}\n`);
  ...
  if (passedTests === totalTests) {
    console.log('\n🎉 All tests passed! Vertex AI function calling is working correctly.');
  } else {
